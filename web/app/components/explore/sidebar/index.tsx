...
const SideBar: FC<IExploreSideBarProps> = ({
  ...
  const { installedApps, setInstalledApps, isCurrentWorkspaceEditor } = useContext(ExploreContext)
  ...
  return (
    <div className='w-fit sm:w-[248px] shrink-0 px-4 border-gray-200 cursor-pointer'>
